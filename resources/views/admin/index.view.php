...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" <?= RESOURCE_ROOT ?>/assets/admin/img/apple-icon.png">
    <link rel="icon" type="image/png" <?= RESOURCE_ROOT ?>/assets/admin/img/favicon.png">
    ...
    <!-- Nucleo Icons -->
    <link <?= RESOURCE_ROOT ?>/assets/admin/css/nucleo-icons.css" rel="stylesheet" />
    <link <?= RESOURCE_ROOT ?>/assets/admin/css/nucleo-svg.css" rel="stylesheet" />
    ...
    <!-- CSS Files -->
    <link id="pagestyle" <?= RESOURCE_ROOT ?>/assets/admin/css/material-dashboard.css?v=3.1.0" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
                <img <?= RESOURCE_ROOT ?>/assets/admin/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
        ...
        <div class="sidenav-footer position-absolute w-100 bottom-0 ">
            <div class="mx-3">
                ...
                <a class="btn bg-gradient-primary w-100" href="https://www.creative-tim.com/product/material-dashboard-pro?ref=sidebarfree" type="button">Upgrade to pro</a> </div>
        </div>
    </aside>
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img <?= RESOURCE_ROOT ?>/assets/admin/img/team-2.jpg" class="avatar avatar-sm  me-3 ">
                                            </div>
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img <?= RESOURCE_ROOT ?>/assets/admin/img/small-logos/logo-spotify.svg" class="avatar avatar-sm bg-gradient-dark  me-3 ">
                                            </div>
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="text-sm font-weight-normal mb-1">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="w-30">
                                                                <div class="d-flex px-2 py-1 align-items-center">
                                                                    <div>
                                                                        <img <?= RESOURCE_ROOT ?>/assets/admin/img/icons/flags/US.png" alt="Country flag">
                                                                    </div>
                                                                    <div class="ms-4">
                                                        ...
                                                        <tr>
                                                            <td class="w-30">
                                                                <div class="d-flex px-2 py-1 align-items-center">
                                                                    <div>
                                                                        <img <?= RESOURCE_ROOT ?>/assets/admin/img/icons/flags/DE.png" alt="Country flag">
                                                                    </div>
                                                                    <div class="ms-4">
                                                                        <p class="text-xs font-weight-bold mb-0 ">Country:</p>
                                                        ...
                                                        <tr>
                                                            <td class="w-30">
                                                                <div class="d-flex px-2 py-1 align-items-center">
                                                                    <div>
                                                                        <img <?= RESOURCE_ROOT ?>/assets/admin/img/icons/flags/GB.png" alt="Country flag">
                                                                    </div>
                                                                    <div class="ms-4">
                                                                        <p class="text-xs font-weight-bold mb-0 ">Country:</p>
                                                        ...
                                                        <tr>
                                                            <td class="w-30">
                                                                <div class="d-flex px-2 py-1 align-items-center">
                                                                    <div>
                                                                        <img <?= RESOURCE_ROOT ?>/assets/admin/img/icons/flags/BR.png" alt="Country flag">
                                                                    </div>
                                                                    <div class="ms-4">
                                                                        <p class="text-xs font-weight-bold mb-0 ">Country:</p>
    ...
    <!--   Core JS Files   -->
    <script <?= RESOURCE_ROOT ?>/assets/admin/js/core/popper.min.js"></script>
    <script <?= RESOURCE_ROOT ?>/assets/admin/js/core/bootstrap.min.js"></script>
    <script <?= RESOURCE_ROOT ?>/assets/admin/js/plugins/perfect-scrollbar.min.js"></script>
    <script <?= RESOURCE_ROOT ?>/assets/admin/js/plugins/smooth-scrollbar.min.js"></script>
    ...
    <script <?= RESOURCE_ROOT ?>/assets/admin/js/material-dashboard.min.js?v=3.1.0"></script>
</body>
